...
# Plot
uviz.plotly_intervals(y_pred, y_std, y_true, show=True)
uviz.plotly_calibration(y_pred, y_std, y_true, show=True)
uviz.plotly_intervals_ordered(y_pred, y_std, y_true, show=True)
