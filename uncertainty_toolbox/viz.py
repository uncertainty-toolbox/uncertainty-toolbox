...
def plotly_intervals(
    ...
    fig.add_trace(go.Scatter(x=y_true, y=y_pred,  
            ...
            name="Predicted", 
            line=dict(color="#ff7f0e", width=2)))
    fig.add_trace(go.Scatter(x=ylims, y=ylims, 
                name="Observations",  
                mode='lines', 
...
def plotly_intervals_ordered(
    ...
    fig.add_trace(go.Scatter(x=xs, y=y_pred, 
                ...
                name="Predicted", 
                line=dict(color="#ff7f0e", width=2)))
    fig.add_trace(go.Scatter(x=xs, y=y_true, 
                name="Observations",  
                mode='lines', 
                line=dict(color="#1f77b4", width=2)))
...
def plotly_xy(
    ...
    fig.add_trace(go.Scatter(x=x, y=y_pred - intervals,
        mode='lines', fill='none',
        line=dict(color='rgba(0,0,0,0)'), 
        hoverinfo="skip", showlegend=False))
    fig.add_trace(go.Scatter(x=x, y=y_pred + intervals, 
        mode='lines', fill='tonexty',
        fillcolor='rgba(255, 153, 0, 0.2)', line=dict(color='rgba(0,0,0,0.0)'),
...
def plotly_calibration(
    ...
    fig.add_trace(go.Scatter(x=[0, 1], y=[0, 1],  
            ...
            name="Predicted", 
            line=dict(color="#ff7f0e", width=2)))
    fig.add_trace(go.Scatter(x=exp_proportions, y=obs_proportions,
             mode='lines',  
             name="True", line=dict(color="#1f77b4", width=2)))
    fig.add_trace(go.Scatter(x=[0, 1], y=[0, 1], mode='lines', fill='none',
            line=dict(color='rgba(0,0,0,0)'), 
            hoverinfo="skip", showlegend=False))
    fig.add_trace(go.Scatter(x=exp_proportions, y=obs_proportions, 
            mode='lines', fill='tonexty',
...
def plotly_calibration_alt(
    ...
    fig.update_xaxes(
        title_text="Predicted proportion in interval",
    ...
    fig.add_annotation(x=0.77, y=0.1,
                text="Miscalibration area = %.2f" % miscalibration_area,
                showarrow=False,
                arrowhead=1)
    if show:
